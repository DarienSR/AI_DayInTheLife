...
namespace UtilityAI.Considerations
{
    ...
    public class NeedToWorkoutConsideration : Consideration
    {
        public override float ScoreConsideration(AgentController agent)
        {
            ...
            float lastExcercised = (agent.environment.currentDay /  agent.stats.lastExcercised) - (agent.stats.lastExcercised / agent.environment.currentDay); // normalize between 0 and 1
